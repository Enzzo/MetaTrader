...
extern string  UniqueID      = "."; // Indicator unique ID
extern int     ButtonsInARow = 14;               // Buttons in a horizontal row
extern int     XShift        = 10;               // Horizontal shift
extern int     YShift        = 10;               // Vertical shift
extern int     XSize         = 110;               // Width of buttons
extern int     YSize         = 21;               // Height of buttons
extern int     FSize         = 12;               // Fort size
extern color   Bcolor        = clrBlack;     // Button color
extern color   Dcolor        = clrDarkGray;      // Button border color
extern color   Tncolor       = clrSilver;         // Text color - normal
...
void createButton(string name, string caption, int xpos, int ypos)
{
   int window = WindowFind(UniqueID);
       ObjectCreate(name,OBJ_BUTTON,window,0,0);
          ...
          ObjectSetText(name,caption,FSize,"Arial Black",Tncolor);
