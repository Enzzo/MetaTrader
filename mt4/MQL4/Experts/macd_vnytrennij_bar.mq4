extern int MA = 3;
extern int FastMACD = 4;
extern int SlowMACD = 12;
extern int SignalMACD = 9;
extern double FiltrBar = 1.0;
extern bool StopFiltr = TRUE;
extern int HighLow = 100;
extern int OrderOpenMax = 4;
extern int Order2_Minute = 60;
extern int Shift = 200;
extern double TakeProfit = 500.0;
extern int TakeProfit2 = 200;
extern double kProfit = 1.9;
extern int Paritet = 100;
extern int Paritet_Shift = 0;
extern int Paritet2 = 100;
extern double Lots = 1.0;
extern double Lots2 = 1.0;
extern double Filtr = 20.0;
extern int MagicNumber = 502360;
extern int MagicNumber2 = 502361;
double g_price_184;
double g_price_192;
double g_price_208;
double g_price_216;
