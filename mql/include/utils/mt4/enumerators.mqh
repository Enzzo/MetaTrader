...
//  |   ENUMERATORS                                                     |
//  +-------------------------------------------------------------------+
//  |   дополнение к ENUM_SYMBOL_INFO_DOUBLE                            |
//  +-------------------------------------------------------------------+
ushort SYMBOL_MARGIN_HEDGED = 77;

//  +-------------------------------------------------------------------+
//  |   ENUMERATORS                                                     |
//  +-------------------------------------------------------------------+
//  |   дополнение к ENUM_SYMBOL_INFO_INTEGER                           |
//  +-------------------------------------------------------------------+
ushort SYMBOL_MARGIN_HEDGED_USE_LEG = 82;

//  +-------------------------------------------------------------------+
//  |   ENUMERATORS                                                     |
//  +-------------------------------------------------------------------+
//  |   дополнение к GetLastError                                       |
//  +-------------------------------------------------------------------+
ushort ERR_MARKET_UNKNOWN_SYMBOL = 4301;
